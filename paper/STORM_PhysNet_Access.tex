...
number; for instance, the architecture-matched baseline remains near persistence at 1\,h (PE$_{\mathrm{pers}}\approx-0.01$), whereas STORM-Bz is clearly positive (PE$_{\mathrm{pers}}\approx+0.31$). Under synthetic input noise (\(\sigma=1.0\)), the architecture-matched Transformer's 6\,h PE drops to \(0.825\pm 0.010\), while STORM maintains \(0.848\pm 0.008\); we do not treat this robustness probe as a primary table. Horizon-restricted physics losses did not improve PE in a fifteen-seed
ablation.
