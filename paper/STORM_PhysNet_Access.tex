...
\textbf{\textbf{This work} & TF + delay + \(B_z\) gate & 1\,h / 6\,h / 12\,h & 15-seed protocol; honest module ablations; GOES$\rightarrow$GRASP transfer \\
\bottomrule
\end{tabular}
\end{table*}
...
Communication Engineering (Machine Learning) at RV College of Engineering, Bengaluru, India.
